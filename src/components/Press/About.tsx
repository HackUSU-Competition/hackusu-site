...
const About: FC = () => {
  ...
  return (
    ...
    >
      <Text size="xl" mb={60}>
        Every year, hundreds of students come to USU from across Utah and Idaho
        to build projects and attend workshops related to topics from game
        development and data analytics to hardware and security. The event venue
        is open overnight, and many teams stay up working all 24 hours!
      </Text>
      ...
      <Text mt={10}>
        All college students and high school seniors are invited to participate!
        Most are from USU, but about 30% typically come in from other schools
        across Utah and Idaho. Students of all skill levels are welcome to
      ...
      <Text mt={10}>
        HackUSU is a 24 hour overnight event with plenty of activities offered
        including:
        <ul>
          <li>
            Competitions to build projects related to software development, data
      ...
      <Container size="sm">
        <AnimateUpOnce>
          <Blockquote my={40} cite="– Chandler Peterson, Student">
            I really loved the workshops, they helped me get a foot in the door
            for many concepts I wanted to learn more about but did not know
            where I could learn about it.
          </Blockquote>
        </AnimateUpOnce>
