      ...
      <Grid align="center" justify="center">
        ...
        <Grid.Col sm={6} md={7}>
          ...
          <Text mt={10}>
            ...
            to arrange parking on campus. We will coordinate with the USU Parking Office to provide
            any necessary permits for free.
          </Text>
          <Text mt={10}>
            After arriving, please check-in at the north entrance of Huntsman Hall to pick up your
            badge. You are welcome to attend all portions of the event and join us for any of the
            meals.
          </Text>
        </Grid.Col>
      </Grid>
