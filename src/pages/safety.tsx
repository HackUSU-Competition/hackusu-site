import {Anchor, Button, Center, List, Text} from "@mantine/core"
import Section from "components/Layout/Section"
import PageTitle from "components/PageTitle"
import SubSectionTitle from "components/SubsectionTitle"
import {DISCORD_INVITE} from "utils/navigationContent"
    ...
    <Layout>
      ...
      <Section title="Code of Conduct">
        ...
        <Text component="p">
          ...
          physical appearance, body size, race, religion, social class, economic
          status, veteran status. Additional cases of harassment include but not
        ...
        <Text component="p">
          Sponsors, judges, mentors, volunteers, organizers, and anyone else
          participating in the event are also subject to the anti-harassment
          policy. In particular, attendees should not use sexualised images,
        ...
        <Text component="p">
          If a participant engages in harassing behavior, HackUSU organizers may
          take any action they deem appropriate, including warning the offender,
          expulsion from the event, or contacting the USU Police Department.
        </Text>
        ...
        <Text component="p">
          ...
          <br />
          <b>USU Police: </b>{" "}
          <Anchor href={`tel:${USU_POLICE_PHONE}`}>{USU_POLICE_PHONE}</Anchor>
        </Text>
      </Section>
      ...
      <Section title="Risk Management Plan" background="light">
        ...
        <Text component="p">
          HackUSU organizers have worked with USU Risk Management to develop a
          plan to ensure the safety of all attendees at HackUSU. This includes
          policies for:
        </Text>
