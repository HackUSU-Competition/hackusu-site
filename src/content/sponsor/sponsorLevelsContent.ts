...
export const sponsorLevelTableData: BenefitGroup[] = [
  {
    ...
    benefits: [
      ...
      },
      {
        ...
        tooltip: 'Info-sessions allow you to promote your company, products, or services.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    benefits: [
      ...
      },
      {
        ...
        levels: levelsAbove(LevelName.TITLE),
        tooltip: 'Title sponsor may co-brand the event. Ex. HackUSU presented by YOUR COMPANY',
      },
    ],
  },
];
